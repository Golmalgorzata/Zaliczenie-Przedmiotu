...
#define adc 34  //adc 10 pin po lutowaniu
...
analogSetPinAttenuation(adc,ADC_6db);       
    ...
    pinMode(bLED, OUTPUT); //wewn dioda  LED
    ...
    if (Serial.available() > 0) {
        ...
        if(command.startsWith("MF")){
            ...
            */
            ...
            //blocking main loop due to measurment
            ...
            Serial.println("Continius measurment -> serial plot");
            digitalWrite(iLED, HIGH);
            for(;;){
